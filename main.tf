...
module "iac_consul" {
  ...
  replicas = var.iac_consul_replicas
...
module "iac_mysql" {
  ...
  replicas = var.iac_mysql_replicas
...
module "iac_nginx" {
  ...
  replicas = var.iac_nginx_replicas
...
module "iac_portal" {
  ...
  replicas = var.iac_portal_replicas
...
module "iac_runner" {
    ...
    image = var.iac_cloudiac_image
    replicas = var.iac_runner_replicas
}
